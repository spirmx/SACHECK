...
`2.0.9` adds the Home alert panel, app-wide workflow animations, and a live network sidebar card.
...
`2.0.9` is the current required release and preserves safe refresh, offline-first Work data, settings, and cache.
