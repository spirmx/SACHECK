                        ...
                        ft.Row(
                            ...
                            controls=[
                                ...
                                ft.Button(
                                    ...
                                    style=ft.ButtonStyle(bgcolor="#115E59", color=WHITE, side=ft.BorderSide(1, "#5EEAD4"), shape=ft.RoundedRectangleBorder(radius=12)),
                                ),
                                ft.Button(
                                    "Settings",
                                    icon=ft.Icons.TUNE_OUTLINED,
                                    on_click=lambda _e: ctx.show_settings(),
                                    style=ft.ButtonStyle(color=WHITE, side=ft.BorderSide(1, "#5EEAD4"), shape=ft.RoundedRectangleBorder(radius=12)),
                                ),
                            ],
                        ),
                    ],
