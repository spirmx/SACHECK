...
VersionInfoProductVersion=2.1.0.3
...
[Files]
Source: "..\build\windows_2.1.0-3\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
